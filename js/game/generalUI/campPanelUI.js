function camp(campsPanel, campsPanelButton, campsButtonText, campsPanelIcon, messagePanelButton, vaultPanelButton){
    ...
    campsPanelButton.hover = PIXI.loader.resources["campsVaultPanel"].textures['buttn_hovered.png'];
    campsPanelButton.pressed = PIXI.loader.resources["campsVaultPanel"].textures['buttn_pressed.png'];
    campsPanelButton.normal = PIXI.loader.resources["campsVaultPanel"].textures['buttn_usual.png'];
